...
/**
 * A RichTapVibrationEffect describes a haptic effect to be performed by a
 * {@link Vibrator}.
 *
 * These effects may be any number of things, from single shot vibrations to
 * complex waveforms, and to AAC extended effects.
 */
public class RichTapVibrationEffect {
    ...
    private static final int CUSTOM_CLIENT = 0x0001 << 16;
    private static final int MAJOR_RICHTAP_VERSION = 0x0020 << 8;
    private static final int MINOR_RICHTAP_VERSION = 0x0010 << 0;

    private static final HashMap<String, Integer> EFFECT_STRENGTH = new HashMap<>();
    static {
        EFFECT_STRENGTH.put("LIGHT", VibrationEffect.EFFECT_STRENGTH_LIGHT);
        EFFECT_STRENGTH.put("MEDIUM", VibrationEffect.EFFECT_STRENGTH_MEDIUM);
        EFFECT_STRENGTH.put("STRONG", VibrationEffect.EFFECT_STRENGTH_STRONG);
    }
    private static final String DEFAULT_EXT_PREBAKED_STRENGTH = "STRONG";
    ...
    public static VibrationEffect createExtPreBaked(@NonNull int effectId, int strength) {
        int strengthValue = EFFECT_STRENGTH.get(DEFAULT_EXT_PREBAKED_STRENGTH);
    ...
    @NonNull
    public static VibrationEffect createEnvelope(@NonNull int[] relativeTimeArr,
            @NonNull int[] scaleArr, @NonNull int[] freqArr, boolean steepMode, int amplitude) {
    ...
    @NonNull
    public static VibrationEffect createPatternHeWithParam(@NonNull int[] patternInfo, int looper, int interval,
            int amplitude, int freq) {
    ...
    public static int checkIfRichTapSupport() {
        ...
        return CUSTOM_CLIENT | MAJOR_RICHTAP_VERSION | MINOR_RICHTAP_VERSION;
    }
    ...
    public static final class ExtPrebaked extends VibrationEffect implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<ExtPrebaked> CREATOR = new Parcelable.Creator<ExtPrebaked>() {
            @Override
    ...
    public static final class Envelope extends VibrationEffect implements Parcelable {
        ...
        public Envelope(@NonNull int[] relativeTimeArr, @NonNull int[] scaleArr, @NonNull int[] freqArr,
        ...
        public boolean equals(Object o) {
            ...
            if (other.isSteepMode() != this.steepMode) {
                return false;
            }
            return true;
        }
        ...
        public static final @NonNull Parcelable.Creator<Envelope> CREATOR = new Parcelable.Creator<Envelope>() {
            @Override
    ...
    public static final class PatternHeParameter extends VibrationEffect implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<PatternHeParameter> CREATOR = new Parcelable.Creator<PatternHeParameter>() {
            @Override
    ...
    public static final class HapticParameter extends VibrationEffect implements Parcelable {
        ...
        @Override
        public void validate() {
            if (mParam == null || 0 == mParam.length || mLength != mParam.length) {
        ...
        public static final @NonNull Parcelable.Creator<HapticParameter> CREATOR = new Parcelable.Creator<HapticParameter>() {
            @Override
    ...
    public static final class PatternHe extends VibrationEffect implements Parcelable {
        ...
        public static final @NonNull Parcelable.Creator<PatternHe> CREATOR = new Parcelable.Creator<PatternHe>() {
            @Override
    ...
    public static final @NonNull Parcelable.Creator<VibrationEffect> CREATOR = new Parcelable.Creator<VibrationEffect>() {
        @Override
