...
public class LauncherUtils {
    ...
    private static final String PROP_SELECTED_LAUNCHER = "persist.sys.sun.launcher";
    private static final String PROP_SELECTED_LAUNCHER_CACHED = "sys.sun.launcher_cached";
