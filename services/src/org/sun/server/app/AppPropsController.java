...
import static org.sun.content.ContextExt.APP_PROPS_MANAGER_SERVICE;
...
public class AppPropsController extends IOnlineConfigurable.Stub {
    ...
    private static final String LOCAL_CONFIG_FILE = "/data/sun_configs/custom_props_config.xml";
    ...
    public String getOnlineConfigUri() {
        return SystemProperties.get("persist.sys.sun.uri.props");
    }
