...
import static com.android.internal.util.sun.BatteryFeatureSettingsHelper.quietModeStatusToString;
...
class QuietModeController {
    ...
    QuietModeController(Handler handler, SunSystemExService service,
