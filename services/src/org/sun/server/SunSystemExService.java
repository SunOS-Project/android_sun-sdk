...
import org.sun.server.app.AppPropsController;
import org.sun.server.app.GameModeController;
import org.sun.server.battery.BatteryFeatureController;
...
import org.sun.server.vibrator.LinearmotorVibratorController;
import org.sun.server.wm.DisplayResolutionController;
import org.sun.server.wm.DisplayRotationController;

public class SunSystemExService extends SystemService {

    private static final String TAG = "SunSystemExService";

    private static final String ACTION_REBOOT = "org.sun.intent.REBOOT_NOW";
    ...
    public SunSystemExService(Context context) {
        super(context);
        ...
        if (phase == PHASE_SYSTEM_SERVICES_READY) {
            ...
            mScreenStateListener = new ScreenStateListener(getContext(), mHandler) {
                ...
                public void onScreenOff() {
                    SunSystemExService.this.onScreenOff();
                }

                @Override
                public void onScreenOn() {
                    SunSystemExService.this.onScreenOn();
                }

                @Override
                public void onScreenUnlocked() {
                    SunSystemExService.this.onScreenUnlocked();
                }
            };
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            SunSystemExService.this.onPackageRemoved(packageName);
        }
