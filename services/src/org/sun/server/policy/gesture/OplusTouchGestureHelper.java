...
import static vendor.sun.hardware.displayfeature.Command.CMD_INIT_TOUCH_GESTURE;
import static vendor.sun.hardware.displayfeature.Command.CMD_REPORT_TOUCH_GESTURE;
...
class OplusTouchGestureHelper {
    ...
    private static final boolean TOUCH_GESTURE_OPLUS_MODE =
            SystemProperties.getBoolean("sys.sun.feature.touch_gesture.oplus", false);
