...
public class SystemSettingsValidatorsExt {
    ...
    static {
        ...
        VALIDATORS.put(System.SYSTEM_TOOL_WINDOWING_MODE_GESTURE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.GAME_MODE_DISABLE_AUTO_BRIGHTNESS, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.GAME_MODE_DISABLE_THREE_FINGER_GESTURES, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.GAME_MODE_DISABLE_HEADS_UP, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.GAME_MODE_LOCK_GESTURES, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.GAME_MODE_LOCK_STATUS_BAR, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.GAME_MODE_RINGER_MODE, new InclusiveIntegerRangeValidator(-1, 2));
        VALIDATORS.put(System.GAME_MODE_STAY_AWAKE, BOOLEAN_VALIDATOR);
