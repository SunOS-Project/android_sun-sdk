...
public class OptimizedChargeFloorPreferenceController extends BasePreferenceController {
    ...
    public OptimizedChargeFloorPreferenceController(Context context, String key) {
        super(context, key);
        mContext = context;
    }
    ...
    public final void updateState(Preference preference) {
        ...
        mPreference.setValue(BatteryFeatureSettingsHelper.getOptimizedChargingFloor(mContext));
    }
}
