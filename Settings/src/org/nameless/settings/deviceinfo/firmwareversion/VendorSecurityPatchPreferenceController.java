...
public class VendorSecurityPatchPreferenceController extends BasePreferenceController {

    private static final String TAG = "VendorSecurityPatchCtrl";

    private static final String KEY_AOSP_VENDOR_SECURITY_PATCH =
            "ro.vendor.build.security_patch";
    private static final String KEY_NAMELESS_VENDOR_SECURITY_PATCH =
            "ro.nameless.build.vendor_security_patch";

    public VendorSecurityPatchPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        ...
        if (patchLevel.isEmpty()) {
            patchLevel = SystemProperties.get(KEY_NAMELESS_VENDOR_SECURITY_PATCH);
        }
