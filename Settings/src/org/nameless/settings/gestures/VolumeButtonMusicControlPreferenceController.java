...
import static org.nameless.provider.SettingsExt.System.VOLBTN_MUSIC_CONTROLS;
...
public class VolumeButtonMusicControlPreferenceController extends GesturePreferenceController {
    ...
    public boolean isChecked() {
        return Settings.System.getIntForUser(mContext.getContentResolver(),
                VOLBTN_MUSIC_CONTROLS, OFF, UserHandle.USER_CURRENT) == ON;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return Settings.System.putIntForUser(mContext.getContentResolver(),
                VOLBTN_MUSIC_CONTROLS, isChecked ? ON : OFF, UserHandle.USER_CURRENT);
    }
}
