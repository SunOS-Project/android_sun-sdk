...
public class QSTileVibrationPreferenceController extends CustomVibrationTogglePreferenceController {
    ...
    public QSTileVibrationPreferenceController(Context context, String preferenceKey) {
        super(context, preferenceKey, new CustomVibrationPreferenceConfig(
                context, Settings.System.HAPTIC_FEEDBACK_ENABLED, SettingsExt.System.CUSTOM_HAPTIC_ON_QS_TILE));
    }
}
