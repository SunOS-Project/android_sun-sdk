...
public class VolumePanelPosPortPreferenceController extends BasePreferenceController {

    private SystemSettingListPreference mPreference;

    public VolumePanelPosPortPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void updateState(Preference preference) {
        ...
        mPreference.setValue(String.valueOf(Settings.System.getIntForUser(
                ...
                VOLUME_PANEL_POSITION_PORT, posPortDefault, UserHandle.USER_CURRENT)));
