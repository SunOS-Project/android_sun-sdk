...
public class OptimizedChargeStatusPreferenceController extends BasePreferenceController {

    private final Context mContext;

    private SystemSettingListPreference mPreference;

    public OptimizedChargeStatusPreferenceController(Context context, String key) {
        super(context, key);
        mContext = context;
    }
    ...
    public final void updateState(Preference preference) {
        ...
        mPreference.setValue(String.valueOf(BatteryFeatureSettingsHelper.getOptimizedChargingStatus(mContext)));
    }
}
