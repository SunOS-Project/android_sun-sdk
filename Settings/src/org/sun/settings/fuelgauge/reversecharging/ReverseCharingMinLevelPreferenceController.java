...
public class ReverseCharingMinLevelPreferenceController extends BasePreferenceController {

    private final Context mContext;

    private SystemSettingSeekBarPreference mPreference;

    public ReverseCharingMinLevelPreferenceController(Context context, String key) {
        super(context, key);
        mContext = context;
    }
